...
#
# Generated by Vivado on Fri Nov 10 11:39:15 +0200 2023
# SW Build 3671981 on Fri Oct 14 05:00:03 MDT 2022
#
# Tool Version Limit: 2022.10 
#
# usage: fp_abs.sh [-help]
# usage: fp_abs.sh [-lib_map_path]
# usage: fp_abs.sh [-noclean_files]
# usage: fp_abs.sh [-reset_run]
#
...
# executing this script. Please type 'fp_abs.sh -help' for more information.
#
...
# Script info
echo -e "fp_abs.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../FIFO_buffer_IP_Core.gen/sources_1/ip/fp_abs/sim/fp_abs.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_abs xil_defaultlib.glbl -o fp_abs_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_abs_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fp_abs.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key fp_abs_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc fp_abs_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fp_abs.sh -help\" for more information)\n"
    exit 1
  fi
